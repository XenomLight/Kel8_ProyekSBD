...
from ..definisi.buku import Buku


def add(Judul, ISBN, TahunPublikasi, StatusTersedia, IdPengarang, IdPenerbit, IdRak):
	new_buku = Buku(
		Judul=Judul,
		ISBN=ISBN,
...
def update(Id, Judul=None, ISBN=None, TahunPublikasi=None, StatusTersedia=None, IdPengarang=None, IdPenerbit=None, IdRak=None):
	buku = Buku.query.get(Id)
	if not buku:
		return None
